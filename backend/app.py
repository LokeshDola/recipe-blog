...
app = Flask(__name__)
CORS(app, resources={r"/api/*": {"origins": "https://recipe-blog-1-05zo.onrender.com"}})
...
def seed_database():
    ...
    if Recipe.query.count() == 0:
        ...
        recipes_to_add = [
            ...
            Recipe(title="Classic Cheesecake", cook_time=90, image="/uploads/chesecake.jpghese", ingredients="Cream Cheese\nSugar\nEggs\nGraham Cracker Crust\nVanilla", instructions="Make crust.\nMix filling.\nBake and chill.", user_id=user1.id, category="Dessert")
        ]
        db.session.add_all(recipes_to_add); db.session.commit()

# This is the corrected block for running the app
