...
class User(db.Model):
    id = db.Column(db.Integer, primary_key=True); username = db.Column(db.String(80), unique=True, nullable=False); password = db.Column(db.String(60), nullable=False); reviews = db.relationship('Review', backref='user', lazy=True)
...
def seed_database():
    ...
    if Recipe.query.count() == 0:
        ...
        # UPDATED: All recipes now use local paths from your 'uploads' folder
        recipes_to_add = [
